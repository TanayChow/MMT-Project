...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 197.0, 420.0, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1293.0, 724.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1220.0, 724.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1220.0, 647.0, 160.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1220.0, 677.0, 82.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 959.0, 852.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 341.0, 477.0, 146.0, 552.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 509.0, 477.0, 561.0, 22.0 ],
					"text" : "dict.unpack leftWrist: rightWrist:"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 147.5, 18.0, 63.0, 22.0 ],
					"text" : "script stop"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 67.5, 18.0, 64.0, 22.0 ],
					"text" : "script start"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 66.0, 161.0, 556.0, 22.0 ],
					"saved_object_attributes" : 					{
						"autostart" : 1,
						"defer" : 0,
						"watch" : 1
...
,
					"text" : "node.script /Users/tanchow/Downloads/MMT-Project/Posenet-Max-p5/server.js @watch 1 @autostart 1"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 322.5, 1204.0, 171.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 322.5, 1368.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1016.5, 852.0, 155.5, 20.0 ],
...
,
					"patching_rect" : [ 322.5, 1125.0, 171.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					"angle" : 270.0,
					"bgcolor" : [ 0.423529411764706, 0.36078431372549, 0.074509803921569, 1.0 ],
					"id" : "obj-37",
					"maxclass" : "panel",
					"mode" : 0,
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"angle" : 270.0,
					"grad1" : [ 0.309803921568627, 0.533333333333333, 0.250980392156863, 1.0 ],
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 192.0, 420.0, 1197.0, 638.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					"angle" : 270.0,
					"grad1" : [ 0.886274509803922, 0.156862745098039, 0.313725490196078, 1.0 ],
					"grad2" : [ 0.2, 0.2, 0.2, 1.0 ],
					"id" : "obj-44",
					"maxclass" : "panel",
					"mode" : 1,
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 192.0, 1096.0, 680.0, 322.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 1 ],
					"midpoints" : [ 24.5, 1350.0, 358.0, 1350.0 ],
					"order" : 0,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 24.5, 1331.0, 332.0, 1331.0 ],
					"order" : 1,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 867.5, 1079.0, 332.0, 1079.0 ],
					"order" : 1,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 518.5, 466.5, 1229.5, 466.5 ],
					"order" : 0,
					"source" : [ "obj-26", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 1 ],
					"midpoints" : [ 518.5, 1094.0, 408.0, 1094.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 2 ],
					"midpoints" : [ 699.0, 1108.0, 484.0, 1108.0 ],
					"source" : [ "obj-43", 0 ]
				}
...
, 			{
				"name" : "dict-array.js",
				"bootpath" : "~/Downloads/MMT-Project",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}

...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 685.5, 37.0, 400.0, 220.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 106.0, 196.0, 423.0, 22.0 ],
					"saved_object_attributes" : 					{
						"autostart" : 0,
						"defer" : 0,
						"watch" : 1
...
,
					"text" : "node.script /Users/tanchow/Downloads/p5/empty-example/server.js @watch 1"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "server.js",
				"bootpath" : "~/Downloads/p5/empty-example",
				"patcherrelativepath" : "./empty-example",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
